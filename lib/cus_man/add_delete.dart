...
// =======================================================
  // ... (بقية الدوال مثل _showAddAccountDialog, _showAddCustomerDialog, _showAddAgentDialog, _saveCustomer, _saveAgent)
...
// ==================================================================================
  // ... (بقية الدوال مثل _buildInfoRow, _deleteCustomer, _showCustomerDetails, _updateCustomer, _showSuccessMessage, _showErrorMessage)
...
class _AddDeletePageState extends State<AddDeletePage> {
  ...
  void _showAddCustomerDialog() {
    showDialog(
                ...
                Container(
                  ...
                  child: Column(
                    children: [
                      TextField(
                        controller: _nameController,
                        autofocus: true, // التركيز التلقائي على حقل الاسم
                        ...
                        onEditingComplete: () {
                          // عند الضغط على "التالي"، يتم نقل التركيز إلى حقل رقم الهاتف
                          FocusScope.of(context).nextFocus();
                        },
                      ),
                      const SizedBox(height: 15),
                      TextField(
                        ...
                        keyboardType: TextInputType.phone,
                        textInputAction: TextInputAction.done, // زر "تم"
                        onEditingComplete: () {
                          // عند الضغط على "تم"، يتم إغلاق لوحة المفاتيح
                          FocusScope.of(context).unfocus();
                        },
                      ),
                    ],
      ...
      // عند إغلاق النافذة، يتم وضع المؤشر بعد آخر حرف في حقل الاسم
      _nameController.selection = TextSelection.fromPosition(
        TextPosition(offset: _nameController.text.length),
      );
    });
              ...
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Table(
                        columnWidths: const {
                          0: FlexColumnWidth(2.5), // الكلمات التعريفية 20%
                          1: FlexColumnWidth(7.5), // البيانات 80%
                        },
                        border: TableBorder.all(
                          color: Colors.cyan,
                          width: 1.5,
